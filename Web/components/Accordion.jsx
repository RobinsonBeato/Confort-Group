  ...
  return (
    <div className="accordion-item ">
      <div className="accordion-title " onClick={onClick}>
        ...
        <span className="accordion-icon open accordion-content"  >{isOpen ? <ion-icon style={{ color: 'var(--color-primary)'}} name="remove-outline"></ion-icon> : <ion-icon style={{ color: 'var(--color-primary)'}} name="add-outline"></ion-icon> }</span>
      </div>
