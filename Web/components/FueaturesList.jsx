...
const features = [
    ...
    { id: "habitaciones", text: "HABITACIONES INDIVIDUALES CON BAÑO PRIVADO", icon: <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><path fill="currentColor" d="M7 14c1.66 0 3-1.34 3-3S8.66 8 7 8s-3 1.34-3 3s1.34 3 3 3m0-4c.55 0 1 .45 1 1s-.45 1-1 1s-1-.45-1-1s.45-1 1-1m12-3h-8v8H3V5H1v15h2v-3h18v3h2v-9c0-2.21-1.79-4-4-4m2 8h-8V9h6c1.1 0 2 .9 2 2Z" /></svg> },
    { id: "habitacionescompartidas", text: "HABITACIONES COMPARTIDAS", icon: <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"><path fill="currentColor" d="M7 14c1.66 0 3-1.34 3-3S8.66 8 7 8s-3 1.34-3 3s1.34 3 3 3m0-4c.55 0 1 .45 1 1s-.45 1-1 1s-1-.45-1-1s.45-1 1-1m12-3h-8v8H3V5H1v15h2v-3h18v3h2v-9c0-2.21-1.79-4-4-4m2 8h-8V9h6c1.1 0 2 .9 2 2Z" /></svg> },
...
const FeaturesList = ({ residencialNames }) => {
    return (
        <section className="about" id="residencial-renacer">
            ...
            <div className="about-content section-content">
                ...
                <p className="section-subtitle margin">Amenities</p>

                <h2 className="h3 section-title margin">Nuestras Comodidades </h2>

                <p className="section-text margin">
                    En nuestra residencia {residencialNames}, ofrecemos una amplia gama de comodidades diseñadas para garantizar el confort, la seguridad y el bienestar de nuestros residentes. Desde habitaciones privadas con baño hasta instalaciones de entretenimiento y recreación, cada detalle está cuidadosamente pensado para proporcionar un ambiente acogedor y enriquecedor. Descubre las características que hacen de nuestra residencia un lugar especial para vivir.
                </p>
            ...
            <div className="features-list">
                {features.map((feature, index) => (
                    <div key={feature.id} className="feature-item">
                        <div className="icon">
                            <div style={{ color: "white" }} className="card-icon">
                                {feature.icon}
                            </div>
                        </div>
