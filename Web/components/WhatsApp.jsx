...
const WhatsApp = () => {
  ...
  // Tus mensajes en texto “normal”
  const messages = {
    client: "Hola Confort-Group les escribo desde su web, soy cliente interesado en conocer información detallada sobre sus servicios.",
    job: "Hola Confort-Group les escribo desde su web, estoy interesado/a en trabajar con ustedes.",
  };
